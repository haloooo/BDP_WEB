...
class testcase_Basic_Check_for_System_Team_0002(base_case.BaseCase):
    ...
    def testcase_Basic_Check_for_System_Team_0002(self):
        ...
        self.assertTrue(check_result.check_pictures('Demo_Mode_Pop_Up.png', False, 0.8,type='JP'),
                        '"Demo Mode" pop up message is not appear')

        print ("Step4: Confirm Eject key is disabled")
        jp_model_action_util.send('OPEN')
        self.assertTrue(check_result.check_pictures('Demo_Mode_Eject_Key.png', False, 0.8,type='JP'),
